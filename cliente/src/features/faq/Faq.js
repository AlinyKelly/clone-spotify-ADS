...
export default function Faq() {
  return (
    <div className='mb-5' style={{ backgroundColor: 'black' }}>
      <div  >
        <h1 style={{ textAlign: 'center', color: 'white' }}>Como Podemos Ajudar?</h1>
      </div>
      <form className="d-flex">
        <input className="form-control me-2" type="text" placeholder="Qual a sua duvida.." />
        ...
        <div className="card" style={{ top: 100 }}>
          ...
          <div id="collapseOne" className="collapse" data-bs-parent="#accordion">
            <div className="card-body">
              Verifique se sua conexão com a internet está ativada. Se sim, tente reiniciar o aplicativo ou verificar se o app está no modo offline, onde você só poderá escutar as faixas que você tiver feito Download.
            </div>
          </div>
        </div>
        <div className="card" style={{ top: 100 }}>
          ...
          <div id="collapseTwo" className="collapse" data-bs-parent="#accordion">
            <div className="card-body">
              ...
              Observação: existem várias maneiras de criar uma conta: usando um e-mail, um número de telefone, o Facebook, a Apple ou o Google. Tente fazer login usando essas opções para localizar sua conta.
            </div>
          </div>
        </div>
              ...
              <table className="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="table-danger">Somente em Playlists selecionadas</td>
                    <td className="table-success">Sim</td>
                  </tr>
                  <tr>
