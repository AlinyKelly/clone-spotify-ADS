...
export default function MusicPlayer(props) {
          ...
          <div class="d-flex align-items-center">
            ...
            <div>
              <button class="player-button">
                <svg className='text-white' width="16" height="16" xmlns="http://www.w3.org/2000/svg">
  ...
  const PlayerElement = () => {
    ...
    return (
      <button onClick={start_stop} className="player-button" disabled="" aria-label="Pausar" data-testid="control-button-playpause" style={{ buttonSize: '32px;', backgroundColor: 'rgba(255,255,255,.3)' }}>
        <svg role="img" height="16" width="16" viewBox="0 0 16 16">
          <path style={{ display: is_play ? 'none' : 'block' }} d="M2.7 1a.7.7 0 00-.7.7v12.6a.7.7 0 00.7.7h2.6a.7.7 0 00.7-.7V1.7a.7.7 0 00-.7-.7H2.7zm8 0a.7.7 0 00-.7.7v12.6a.7.7 0 00.7.7h2.6a.7.7 0 00.7-.7V1.7a.7.7 0 00-.7-.7h-2.6z"></path>
          <path style={{ display: is_play ? 'block' : 'none' }} d="M3 1.713a.7.7 0 011.05-.607l10.89 6.288a.7.7 0 010 1.212L4.05 14.894A.7.7 0 013 14.288V1.713z"></path>
        </svg>
      </button>
    );
  }
    ...
    <div>
      <div className="bg-black p-4">
        <div className="row">
          ...
          <div className="col">
            <div className="d-flex mb-8 justify-content-center" style={{ gap: '16px' }}>
              <div className="d-flex float-left" style={{ gap: '8px' }}>
                <button className='player-button' role="switch" aria-checked="false" aria-label="Ativar a ordem aleatória" data-testid="control-button-shuffle" style={{ buttonSize: '32px;' }}>
                  <svg role="img" height="16" width="16" viewBox="0 0 16 16" className="Svg-sc-1bi12j5-0 jgfuCe">
                ...
                <button className="player-button" disabled="" aria-label="Voltar"
                  style={{ buttonSize: '32px;' }}><svg role="img" height="16" width="16" viewBox="0 0 16 16"
              ...
              <PlayerElement />
              <div className="d-flex float-right" style={{ gap: '8px' }}>
                <button className="player-button" disabled="" aria-label="Avançar"
                  data-testid="control-button-skip-forward" style={{ buttonSize: '32px;' }}><svg role="img" height="16" width="16"
                    viewBox="0 0 16 16" className="Svg-sc-1bi12j5-0 jgfuCe">
                    <path
                ...
                <button className="player-button" disabled="" role="checkbox" aria-checked="false"
                  aria-label="Não repetir" data-testid="control-button-repeat" style={{ buttonSize: '32px;' }}><svg role="img"
                    height="16" width="16" viewBox="0 0 16 16" className="Svg-sc-1bi12j5-0 jgfuCe">
                    <path
          ...
          <div className="col">
            <div className="d-flex align-items-center justify-content-end">
              <button className="player-button control-button" aria-label="Letra">
                <svg role="img" height="16" width="16" viewBox="0 0 16 16" className="Svg-sc-1bi12j5-0 jgfuCe">
              ...
              <div className="control-button-wrapper">
                <button className="player-button hyWUsx" data-testid="control-button-undefined" aria-label="Fila">
              ...
              <button className="control-button player-button">
                <svg role="img" height="16" width="16" className="Svg-sc-1bi12j5-0 jgfuCe" aria-label="Conectar a um dispositivo" viewBox="0 0 16 16">
              ...
              <div className="volume-bar" data-testid="volume-bar" dir="ltr">
                <button className="player-button control-button"
                  aria-label="Mudo" aria-describedby="volume-icon"><svg role="presentation" height="16" width="16"
                    aria-label="Volume alto" id="volume-icon" viewBox="0 0 16 16" className="Svg-sc-1bi12j5-0 jgfuCe">
